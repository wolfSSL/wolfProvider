    ...
    size_t keyLen)
{
    ...
    WOLFPROV_MSG_DEBUG(WP_LOG_HKDF, "TLS1.3 HKDF expand: prefixLen=%zu, labelLen=%zu", 
    ...
    size_t keyLen, const OSSL_PARAM params[])
{
    ...
    WOLFPROV_MSG_DEBUG(WP_LOG_HKDF, "TLS1.3 KDF derive: keyLen=%zu, mode=%d", keyLen, ctx->mode);
