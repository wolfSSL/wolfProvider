    ...
    size_t keyLen, const OSSL_PARAM params[])
{
    ...
    WOLFPROV_ENTER(WP_LOG_COMP_MAC, "wp_cmac_init");
    ...
    size_t outSize)
{
    ...
    WOLFPROV_ENTER(WP_LOG_COMP_MAC, "wp_cmac_final");
...
static int wp_cmac_get_ctx_params(wp_CmacCtx* macCtx, OSSL_PARAM params[])
{
    ...
    WOLFPROV_ENTER(WP_LOG_COMP_MAC, "wp_cmac_get_ctx_params");
...
static int wp_cmac_setup_cipher(wp_CmacCtx* macCtx, const OSSL_PARAM params[])
{
    ...
    WOLFPROV_ENTER(WP_LOG_COMP_MAC, "wp_cmac_setup_cipher");
...
static int wp_cmac_set_param_key(wp_CmacCtx* macCtx, const OSSL_PARAM params[])
{
    ...
    WOLFPROV_ENTER(WP_LOG_COMP_MAC, "wp_cmac_set_param_key");
...
static int wp_cmac_set_ctx_params(wp_CmacCtx* macCtx, const OSSL_PARAM params[])
{
    ...
    WOLFPROV_ENTER(WP_LOG_COMP_MAC, "wp_cmac_set_ctx_params");
