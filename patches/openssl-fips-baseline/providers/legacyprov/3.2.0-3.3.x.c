 ...
 *
 * Modified for wolfProvider FIPS Baseline - Minimal legacy provider for 3.2.0-3.3.x
 */
...
/* FIPS Baseline: Empty legacy digests */
...
/* FIPS Baseline: Empty legacy ciphers */
static const OSSL_ALGORITHM legacy_ciphers[] = {
    { NULL, NULL, NULL }
};

/* FIPS Baseline: Empty legacy KDFs */
