 ...
 *
 * Modified for wolfProvider FIPS Baseline - Minimal default provider for 3.2.0-3.3.x
 */
 ...
 * 3.3.x version - uses simpler algorithm structure without composite signatures
 */
