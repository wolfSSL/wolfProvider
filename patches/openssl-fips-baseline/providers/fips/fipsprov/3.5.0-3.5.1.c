...
/* Note: c_count_to_mark removed for 3.5.0-3.5.1 compatibility */
...
#define set_func(c, f) if (c == NULL) c = f; else if (c != f) return 0;
        ...
        case OSSL_FUNC_CORE_POP_ERROR_TO_MARK:
            ...
            break;
        /* Note: OSSL_FUNC_CORE_COUNT_TO_MARK case removed for 3.5.0-3.5.1 compatibility */
...
/* Note: ERR_count_to_mark removed for 3.5.0-3.5.1 compatibility */
