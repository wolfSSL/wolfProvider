...
extern const OSSL_DISPATCH wp_dh_params_decoder_functions[];
extern const OSSL_DISPATCH wp_dh_spki_decoder_functions[];
extern const OSSL_DISPATCH wp_dh_pki_decoder_functions[];
extern const OSSL_DISPATCH wp_ecc_params_decoder_functions[];
...
extern const OSSL_DISPATCH wp_dh_params_der_encoder_functions[];
extern const OSSL_DISPATCH wp_dh_params_pem_encoder_functions[];
...
extern const OSSL_DISPATCH wp_ecc_params_der_encoder_functions[];
extern const OSSL_DISPATCH wp_ecc_params_pem_encoder_functions[];
