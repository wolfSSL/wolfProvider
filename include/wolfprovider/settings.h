...
#endif
/* SHA-512/224 and /256 are in-boundary from FIPS v7 (the [v7|ready|dev] arm);
 * earlier modules set WOLFSSL_NOSHA512_* and lack wc_HashInit_ex support. */
    ...
    (defined(HAVE_FIPS_VERSION_MAJOR) && HAVE_FIPS_VERSION_MAJOR >= 7))
