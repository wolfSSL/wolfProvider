...
static int test_rsa_decode_pkcs8_evp_pkey(const unsigned char *p1, long len1,
    const unsigned char *p2, long len2)
{
    int err = 0;
    ...
    if (err == 0) {
        ...
        pkey2 = EVP_PKCS82PKEY_ex(p8inf2, wpLibCtx, NULL);
...
int test_rsa_decode_pkcs8(void* data)
{
    ...
    if (err == 0) {
        ...
        err = test_rsa_decode_pkcs8_evp_pkey(
                rsa_pss_key_der_2048_pkcs8_512, sizeof(rsa_pss_key_der_2048_pkcs8_512),
                rsa_pss_key_der_2048_pkcs8_512, sizeof(rsa_pss_key_der_2048_pkcs8_512));
    }
...
static int test_rsa_encode_pkcs8_evp_pkey(const unsigned char *p, long len)
{
    ...
    if (err == 0) {
        ...
        err = test_rsa_decode_pkcs8_evp_pkey(der1, der1_len, der2, der2_len);
    }
