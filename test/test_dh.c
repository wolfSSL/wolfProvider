...
/* Explicit FFC group with p - 1 = 2 * q * 3 * m, so it has a subgroup of
 * order 3 that the [2, p-2] range check does not exclude. */
static const unsigned char dh_ss_p[] = {
    
};

static const unsigned char dh_ss_q[] = {
    0xfe, 0x04, 0xbd, 0x98, 0x3c, 0x4f, 0x98, 0x54,
    0xcd, 0x2b, 0x4b, 0xcb, 0x79, 0x15, 0x35, 0xf5,
    0xe5, 0xfc, 0x1f, 0xb0, 0x2b, 0x5f, 0x9d, 0x1a,
    0xc7, 0x24, 0x63, 0xf6, 0x93, 0x50, 0xdd, 0x8d
};

static const unsigned char dh_ss_g[] = {
    
};

static const unsigned char dh_ss_priv[] = {
    0x62, 0x66, 0x25, 0x39, 0xb9, 0x7c, 0x43, 0xd3,
    0xaf, 0x13, 0xc3, 0xd8, 0xfd, 0x52, 0x7d, 0x0c,
    0x6a, 0x0d, 0x90, 0x80, 0xa8, 0x45, 0x13, 0x4a,
    0x81, 0xd3, 0xf0, 0x5d, 0xe7, 0xab, 0x47, 0x88
};

static const unsigned char dh_ss_pub[] = {
    
};

static const unsigned char dh_ss_peer_pub[] = {
    ,
...
static const unsigned char dh_ss_small_pub[] = {
    
};
    ...
    size_t pubLen, const unsigned char *priv, size_t privLen)
{
    ...
    if (err == 0) {
        err = OSSL_PARAM_BLD_push_BN(bld, OSSL_PKEY_PARAM_PUB_KEY, pubBn) != 1;
    }
    if ((err == 0) && (privBn != NULL)) {
        err = OSSL_PARAM_BLD_push_BN(bld, OSSL_PKEY_PARAM_PRIV_KEY, privBn)
              != 1;
    }
    if (err == 0) {
    ...
    if (err == 0) {
        ctx = EVP_PKEY_CTX_new_from_name(wpLibCtx, "DHX", NULL);
        err = ctx == NULL;
    }
    if (err == 0) {
        err = EVP_PKEY_fromdata_init(ctx) != 1;
    ...
    if (err == 0) {
        selection = (priv != NULL) ? EVP_PKEY_KEYPAIR : EVP_PKEY_PUBLIC_KEY;
...
/*
 * A peer public key confined to a small subgroup must not be used for key
 * agreement. Without the y^q mod p test the range check alone accepts it and
 * the resulting secret leaks our private key modulo the subgroup order.
 */
int test_dh_small_subgroup_peer(void *data)
{
    int err = 0;
    EVP_PKEY *key = NULL;
    EVP_PKEY *peer = NULL;
